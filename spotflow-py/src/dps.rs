...
impl ProvisioningOperation {
    /// (Read-only) The ID of this [Provisioning Operation](https://docs.spotflow.io/connect-devices/#provisioning-operation).
    #[getter]
    pub fn id(&self) -> String {
        self.inner.id.clone()
    }

    /// (Read-only) The verification code of this [Provisioning Operation](https://docs.spotflow.io/connect-devices/#provisioning-operation).
    #[getter]
    pub fn verification_code(&self) -> String {
        self.inner.verification_code.clone()
    }

    /// (Read-only) The expiration time of this [Provisioning Operation](https://docs.spotflow.io/connect-devices/#provisioning-operation).
